...
static struct v4l2_subdev *ar0132_get_interface_subdev(
    struct v4l2_subdev *sd)
{
                                  ...
                                  struct v4l2_subdev_frame_size_enum *fse)
{
    ...
    fse->min_width =
        ar0132_mode_data[0][fse->index].hact;
    fse->max_width = fse->min_width;
    fse->min_height =
        ar0132_mode_data[0][fse->index].vact;
    fse->max_height = fse->min_height;
    return 0;
}

static int ar0132_enum_frame_interval(
    struct v4l2_subdev *sd,
    struct v4l2_subdev_pad_config *cfg,
