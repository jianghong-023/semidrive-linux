...
{
	return container_of(sd, struct n4_dev, sd);
}
...
static struct v4l2_subdev *n4_get_interface_subdev(struct v4l2_subdev *sd)
{
...
static int n4_s_power(struct v4l2_subdev *sd, int on)
{
	...
	struct v4l2_subdev *interface_sd = n4_get_interface_subdev(sd);
...
//  sensor->last_mode = sensor->current_mode;
	...
	v4l2_i2c_subdev_init(&sensor->sd, client, &n4_subdev_ops);
