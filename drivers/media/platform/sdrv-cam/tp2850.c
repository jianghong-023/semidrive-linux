...
static struct v4l2_subdev *tp2850_get_interface_subdev(struct v4l2_subdev *sd)
{
...
static int tp2850_s_power(struct v4l2_subdev *sd, int on)
{
	...
	struct v4l2_subdev *interface_sd = tp2850_get_interface_subdev(sd);
