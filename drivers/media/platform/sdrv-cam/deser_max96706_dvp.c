...
static const struct reg_value_ov OV9284_PLLRegTable[] = {
	{0x0302, 0x20, 0x20, 0x30},
	{0x030D, 0x40, 0x40, 0x60},
	{0x030E, 0x06, 0x06, 0x06},
};

static const struct reg_value_ov OV9284_RegTable[] = {
    /* Addr,  value        */
	{0x0302, 0x30, 0x30, 0x30},
	{0x030d, 0x60, 0x60, 0x60},
	{0x030e, 0x06, 0x06, 0x06},
	{0x3001, 0x62, 0x62, 0x62},
	{0x3004, 0x01, 0x01, 0x01},
	{0x3005, 0xff, 0xff, 0xff},
	{0x3006, 0xe2, 0xe2, 0xe2},  // bit[1]: enable VSYNC output, bit[2]: io_pwm_en
	{0x3011, 0x0a, 0x0a, 0x0a},
	{0x3013, 0x18, 0x18, 0x18},
	{0x301c, 0xf0, 0xf0, 0xf0},
	{0x3022, 0x07, 0x07, 0x07},
	{0x3030, 0x10, 0x10, 0x10},
	{0x3039, 0x2e, 0x2e, 0x2e},
	{0x303a, 0xf0, 0xf0, 0xf0},
	{0x3500, 0x00, 0x00, 0x00},
	{0x3501, 0x2a, 0x2a, 0x2a},
	{0x3502, 0x90, 0x90, 0x90},
	{0x3503, 0x08, 0x08, 0x08},
	{0x3505, 0x8c, 0x8c, 0x8c},
	{0x3507, 0x03, 0x03, 0x03},
	{0x3508, 0x00, 0x00, 0x00},
	{0x3509, 0x10, 0x10, 0x10},
	{0x3610, 0x80, 0x80, 0x80},
	{0x3611, 0xa0, 0xa0, 0xa0},
	{0x3620, 0x6e, 0x6e, 0x6e},
	{0x3632, 0x56, 0x56, 0x56},
	{0x3633, 0x78, 0x78, 0x78},
	{0x3662, 0x05, 0x05, 0x05},
	{0x3666, 0x5a, 0x5a, 0x5a},
	{0x366f, 0x7e, 0x7e, 0x7e},
	{0x3680, 0x84, 0x84, 0x84},
	{0x3712, 0x80, 0x80, 0x80},
	{0x372d, 0x22, 0x22, 0x22},
	{0x3731, 0x80, 0x80, 0x80},
	{0x3732, 0x30, 0x30, 0x30},
	{0x3778, 0x00, 0x00, 0x00},
	{0x377d, 0x22, 0x22, 0x22},
	{0x3788, 0x02, 0x02, 0x02},
	{0x3789, 0xa4, 0xa4, 0xa4},
	{0x378a, 0x00, 0x00, 0x00},
	{0x378b, 0x4a, 0x4a, 0x4a},
	{0x3799, 0x20, 0x20, 0x20},
	{0x3800, 0x00, 0x00, 0x00},   // horizontal start
	{0x3801, 0x00, 0x00, 0x00},   // horizontal start
	{0x3802, 0x00, 0x00, 0x00},   // vertical start
	{0x3803, 0x00, 0x00, 0x00},   // vertical start
	{0x3804, 0x05, 0x05, 0x05},   // horizontal end
	{0x3805, 0x0f, 0x0f, 0x0f},   // horizontal end
	{0x3806, 0x03, 0x03, 0x03},   // vertical end
	{0x3807, 0x2f, 0x2f, 0x2f},   // vertical end
	{0x3808, 0x05, 0x05, 0x05},   // timing_X_output_size
	{0x3809, 0x00, 0x00, 0x00},   // timing_X_output_size
	{0x380a, 0x03, 0x03, 0x02},  // timing_Y_output_size
	{0x380b, 0x20, 0x20, 0xd0},  // timing_Y_output_size
	{0x380c, 0x02, 0x02, 0x02},  // timing_HTS
	{0x380d, 0xd8, 0xd8, 0xe6},  // timing_HTS
	{0x380e, 0x06, 0x05, 0x08},  // timing_VTS
	{0x380f, 0xe0, 0xba, 0x7d},  // timing_VTS
	{0x3810, 0x00, 0x00, 0x00},
	{0x3811, 0x08, 0x08, 0x08},
	{0x3812, 0x00, 0x00, 0x00},
	{0x3813, 0x08, 0x08, 0x08},
	{0x3814, 0x11, 0x11, 0x11},
	{0x3815, 0x11, 0x11, 0x11},
	{0x3820, 0x40, 0x40, 0x40},
	{0x3821, 0x00, 0x00, 0x00},
	{0x382c, 0x05, 0x05, 0x05},
	{0x382d, 0xb0, 0xb0, 0xb0},
	{0x389d, 0x00, 0x00, 0x00},
	{0x3881, 0x42, 0x42, 0x42},
	{0x3882, 0x01, 0x01, 0x01},
	{0x3883, 0x00, 0x00, 0x00},
	{0x3885, 0x02, 0x02, 0x02},
	{0x38a8, 0x02, 0x02, 0x02},
	{0x38a9, 0x80, 0x80, 0x80},
	{0x38b1, 0x00, 0x00, 0x00},
	{0x38b3, 0x02, 0x02, 0x02},
	{0x38c4, 0x00, 0x00, 0x00},
	{0x38c5, 0xc0, 0xc0, 0xc0},
	{0x38c6, 0x04, 0x04, 0x04},
	{0x38c7, 0x80, 0x80, 0x80},
	{0x3920, 0xff, 0xff, 0xff},
	{0x4003, 0x40, 0x40, 0x40},
	{0x4008, 0x04, 0x04, 0x04},
	{0x4009, 0x0b, 0x0b, 0x0b},
	{0x400c, 0x00, 0x00, 0x00},
	{0x400d, 0x07, 0x07, 0x07},
	{0x4010, 0x40, 0x40, 0x40},
	{0x4043, 0x40, 0x40, 0x40},
	{0x4307, 0x30, 0x30, 0x30},
	{0x4317, 0x01, 0x01, 0x01},
	{0x4501, 0x00, 0x00, 0x00},
	{0x4507, 0x00, 0x00, 0x00},
	{0x4509, 0x00, 0x00, 0x00},
	{0x450a, 0x08, 0x08, 0x08},
	{0x4601, 0x04, 0x04, 0x04},
	{0x470f, 0xe0, 0xe0, 0xe0},
	{0x4f07, 0x00, 0x00, 0x00},
	{0x4800, 0x00, 0x00, 0x00},
	{0x5000, 0x9f, 0x9f, 0x9f},
	{0x5001, 0x00, 0x00, 0x00},
	{0x5e00, 0x00, 0x00, 0x00},
	{0x5d00, 0x0b, 0x0b, 0x0b},
	{0x5d01, 0x02, 0x02, 0x02},
	{0x4f00, 0x00, 0x00, 0x00},  // continuous = 0x00, non-continuous = 0x04
	{0x4f10, 0x00, 0x00, 0x00},
	{0x4f11, 0x98, 0x98, 0x98},
	{0x4f12, 0x0f, 0x0f, 0x0f},
	{0x4f13, 0xc4, 0xc4, 0xc4},
};
