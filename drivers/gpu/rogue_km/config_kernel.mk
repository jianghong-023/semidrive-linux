...
ifdef $(CONFIG_PVR_SYSTEM)
override PVR_SYSTEM := $(CONFIG_PVR_SYSTEM)
else
override PVR_SYSTEM := kl_gm9226
endif
ifdef $(CONFIG_VMM_TYPE)
override VMM_TYPE := $(CONFIG_VMM_TYPE)
else
override VMM_TYPE := stub
endif
ifdef $(CONFIG_PVRSRV_VZ_NUM_OSID)
override PVRSRV_VZ_NUM_OSID := $(CONFIG_PVRSRV_VZ_NUM_OSID)
endif

#the build type configs need updated later
#override PVR_BUILD_DIR := kl_gm9226_android
