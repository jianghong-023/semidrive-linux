...
#define RDMA_PRES_WML                    0x101C
#define PRES_REQ_INTERVAL_SHIFT          16UL
#define PRES_REQ_INTERVAL_MASK           0x3FF << PRES_REQ_INTERVAL_SHIFT
#define PRES_WML_DOWN_SHIFT              4UL
#define PRES_WML_DOWN_MASK               0x7 << PRES_WML_DOWN_SHIFT
#define PRES_WML_UP_SHIFT                0UL
#define PRES_WML_UP_MASK                 0x7 << PRES_WML_UP_SHIFT
...
#define RDMA_DEBUG_CTRL                  0x1240
#define DEBUG_CTRL_SEL_SHIFT             0
#define DEBUG_CTRL_SEL_MASK              0xF << DEBUG_CTRL_SEL_SHIFT

#define RDMA_DEBUG_STA                   0x1244
#define DEBUG_STA_CFIFO_DEP_SHIFT        16
#define DEBUG_STA_CFIFO_DEP_MASK         0xFFFF << DEBUG_STA_CFIFO_DEP_SHIFT
#define DEBUG_STA_DFIFO_DEP_SHIFT        0
#define DEBUG_STA_DFIFO_DEP_MASK         0xFFFF << DEBUG_STA_DFIFO_DEP_SHIFT
...
#define GP_FRM_CTRL                      0x0004 /*Note: DP g-pipe this bits is different.*/
