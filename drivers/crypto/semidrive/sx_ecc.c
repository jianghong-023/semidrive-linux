...
static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p192_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p192 = {
    .params  = BLOCK_T_CONV(ecc_p192_params, sizeof(ecc_p192_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P192,
    .bytesize = 24,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p224_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p224 = {
    .params  = BLOCK_T_CONV(ecc_p224_params, sizeof(ecc_p224_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 28,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p256_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p256 = {
    .params  = BLOCK_T_CONV(ecc_p256_params, sizeof(ecc_p256_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P256,
    .bytesize = 32,
};

static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_sm2_p256_params[] =     {
        /* no seed */
        /* p */
...
const sx_ecc_curve_t sx_ecc_sm2_curve_p256 = {
    .params  = BLOCK_T_CONV(ecc_sm2_p256_params, sizeof(ecc_sm2_p256_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME),
    .bytesize = 32,
};

static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_sm2_p256_params_rev[] =     {
        /* no seed */
        /* p */      
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
        ...
        /* order */
        0x23, 0x41, 0xD5, 0x39, 0x09, 0xF4, 0xBB, 0x53, 0x2B, 0x05, 0xC6, 0x21,
        0x6B, 0xDF, 0x03, 0x72, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
        0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF,
        /* x */
        0xC7, 0x74, 0x4C, 0x33, 0x89, 0x45, 0x5A, 0x71, 0xE1, 0x0B, 0x66, 0xF2,
        0xBF, 0x0B, 0xE3, 0x8F, 0x94, 0xC9, 0x39, 0x6A, 0x46, 0x04, 0x99, 0x5F,
        0x19, 0x81, 0x19, 0x1F, 0x2C, 0xAE, 0xC4, 0x32,
        /* y */
        0xA0, 0xF0, 0x39, 0x21, 0xE5, 0x32, 0xDF, 0x02, 0x40, 0x47, 0x2A, 0xC6,
        0x7C, 0x87, 0xA9, 0xD0, 0x53, 0x21, 0x69, 0x6B, 0xE3, 0xCE, 0xBD, 0x59,
        ...
        0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF,
        /* b */
        0x93, 0x0E, 0x94, 0x4D, 0x41, 0xBD, 0xBC, 0xDD, 0x92, 0x8F, 0xAB, 0x15,
        0xF5, 0x89, 0x97, 0xF3, 0xA7, 0x09, 0x65, 0xCF, 0x4B, 0x9E, 0x5A, 0x4D,
        0x34, 0x5E, 0x9F, 0x9D, 0x9E, 0xFA, 0xE9, 0x28
    };

const sx_ecc_curve_t sx_ecc_sm2_curve_p256_rev = {
    .params  = BLOCK_T_CONV(ecc_sm2_p256_params_rev, sizeof(ecc_sm2_p256_params_rev), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME),
    .bytesize = 32,
};

static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p384_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p384 = {
    .params  = BLOCK_T_CONV(ecc_p384_params, sizeof(ecc_p384_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P384,
    .bytesize = 48,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p521_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p521 = {
    .params  = BLOCK_T_CONV(ecc_p521_params, sizeof(ecc_p521_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P521,
    .bytesize = 66,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_b163_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_b163 = {
    .params  = BLOCK_T_CONV(ecc_b163_params, sizeof(ecc_b163_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 21,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_b233_params[] = {
    ...
    0x00, 0x66, 0x64, 0x7e, 0xde, 0x6c, 0x33, 0x2c, 0x7f, 0x8c, 0x09, 0x23, 0xbb, 0x58, 0x21, 0x3b, 0x33, 0x3b, 0x20, 0xe9, 0xce, 0x42, 0x81, 0xfe, 0x11, 0x5f, 0x7d, 0x8f, 0x90, 0xad
};  //b
const sx_ecc_curve_t sx_ecc_curve_b233 = {
    .params  = BLOCK_T_CONV(ecc_b233_params, sizeof(ecc_b233_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 30,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_b283_params[] = {
    ...
    0x02, 0x7b, 0x68, 0x0a, 0xc8, 0xb8, 0x59, 0x6d, 0xa5, 0xa4, 0xaf, 0x8a, 0x19, 0xa0, 0x30, 0x3f, 0xca, 0x97, 0xfd, 0x76, 0x45, 0x30, 0x9f, 0xa2, 0xa5, 0x81, 0x48, 0x5a, 0xf6, 0x26, 0x3e, 0x31, 0x3b, 0x79, 0xa2, 0xf5
};  //b
const sx_ecc_curve_t sx_ecc_curve_b283 = {
    .params  = BLOCK_T_CONV(ecc_b283_params, sizeof(ecc_b283_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 36,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_b409_params[] = {
    ...
    0x00, 0x21, 0xa5, 0xc2, 0xc8, 0xee, 0x9f, 0xeb, 0x5c, 0x4b, 0x9a, 0x75, 0x3b, 0x7b, 0x47, 0x6b, 0x7f, 0xd6, 0x42, 0x2e, 0xf1, 0xf3, 0xdd, 0x67, 0x47, 0x61, 0xfa, 0x99, 0xd6, 0xac, 0x27, 0xc8, 0xa9, 0xa1, 0x97, 0xb2, 0x72, 0x82, 0x2f, 0x6c, 0xd5, 0x7a, 0x55, 0xaa, 0x4f, 0x50, 0xae, 0x31, 0x7b, 0x13, 0x54, 0x5f
};  //b
const sx_ecc_curve_t sx_ecc_curve_b409 = {
    .params  = BLOCK_T_CONV(ecc_b409_params, sizeof(ecc_b409_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 52,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_b571_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_b571 = {
    .params  = BLOCK_T_CONV(ecc_b571_params, sizeof(ecc_b571_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 72,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_k163_params[] = {
    0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc9,     //q
...
const sx_ecc_curve_t sx_ecc_curve_k163 = {
    .params  = BLOCK_T_CONV(ecc_k163_params, sizeof(ecc_k163_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 21,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_k233_params[] = {
...
const sx_ecc_curve_t sx_ecc_curve_k233 = {
    .params  = BLOCK_T_CONV(ecc_k233_params, sizeof(ecc_k233_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 30,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_k283_params[216] = {
    0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0xa1,     //q
...
const sx_ecc_curve_t sx_ecc_curve_k283 = {
    .params  = BLOCK_T_CONV(ecc_k283_params, sizeof(ecc_k283_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 36,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_k409_params[] = {
    0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,     //q
...
const sx_ecc_curve_t sx_ecc_curve_k409 = {
    .params  = BLOCK_T_CONV(ecc_k409_params, sizeof(ecc_k409_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 52,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_k571_params[] = {
    0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x25,     //q
...
const sx_ecc_curve_t sx_ecc_curve_k571 = {
    .params  = BLOCK_T_CONV(ecc_k571_params, sizeof(ecc_k571_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_BINARY) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 72,
};


static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_e521_params[] = {
    0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,  //q
    ...
    0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfa, 0x43, 0x31
}; //d
const sx_ecc_curve_t sx_ecc_curve_e521 = {
    .params  = BLOCK_T_CONV(ecc_e521_params, sizeof(ecc_e521_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_CMD_EDWARDS(1) | BA414EP_SELCUR_ACCEL_P521,
    .bytesize = 66,
};
...
**********************************************************/
static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_curve25519_params[] = {
    ...
    0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};  // x
const sx_ecc_curve_t sx_ecc_curve_curve25519 = {
    .params  = BLOCK_T_CONV(ecc_curve25519_params, sizeof(ecc_curve25519_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_25519,
    .bytesize = 32,
};
...
static const  uint8_t __attribute__((aligned(CACHE_LINE))) ecc_curve448_params[] = {
    ...
    0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
}; //x
const sx_ecc_curve_t sx_ecc_curve_curve448 = {
    .params  = BLOCK_T_CONV(ecc_curve448_params, sizeof(ecc_curve448_params), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_NO_ACCELERATOR,
    .bytesize = 56,
};

//wrong parameters
static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_curve192_params_wrongA[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,     //q
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x99, 0xde, 0xf8, 0x36, 0x14, 0x6b, 0xc9, 0xb1, 0xb4, 0xd2, 0x28, 0x31,     //n
    0x18, 0x8d, 0xa8, 0x0e, 0xb0, 0x30, 0x90, 0xf6, 0x7c, 0xbf, 0x20, 0xeb, 0x43, 0xa1, 0x88, 0x00, 0xf4, 0xff, 0x0a, 0xfd, 0x82, 0xff, 0x10, 0x12,     //gx
    0x07, 0x19, 0x2b, 0x95, 0xff, 0xc8, 0xda, 0x78, 0x63, 0x10, 0x11, 0xed, 0x6b, 0x24, 0xcd, 0xd5, 0x73, 0xf9, 0x77, 0xa1, 0x1e, 0x79, 0x48, 0x11,     //gy
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,    //a
    0x64, 0x21, 0x05, 0x19, 0xe5, 0x9c, 0x80, 0xe7, 0x0f, 0xa7, 0xe9, 0xab, 0x72, 0x24, 0x30, 0x49, 0xfe, 0xb8, 0xde, 0xec, 0xc1, 0x46, 0xb9, 0xb1
};  //b
const sx_ecc_curve_t sx_ecc_curve_curve192_wrongA = {
    .params  = BLOCK_T_CONV(ecc_curve192_params_wrongA, sizeof(ecc_curve192_params_wrongA), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P192,
    .bytesize = 24,
};

uint8_t status;
static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_curve192_params_wrongGx[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,     //q
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x99, 0xde, 0xf8, 0x36, 0x14, 0x6b, 0xc9, 0xb1, 0xb4, 0xd2, 0x28, 0x31,     //n
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,     //gx
    0x07, 0x19, 0x2b, 0x95, 0xff, 0xc8, 0xda, 0x78, 0x63, 0x10, 0x11, 0xed, 0x6b, 0x24, 0xcd, 0xd5, 0x73, 0xf9, 0x77, 0xa1, 0x1e, 0x79, 0x48, 0x11,     //gy
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc,    //a
    0x64, 0x21, 0x05, 0x19, 0xe5, 0x9c, 0x80, 0xe7, 0x0f, 0xa7, 0xe9, 0xab, 0x72, 0x24, 0x30, 0x49, 0xfe, 0xb8, 0xde, 0xec, 0xc1, 0x46, 0xb9, 0xb1
};  //b
const sx_ecc_curve_t sx_ecc_curve_curve192_wrongGx = {
    .params  = BLOCK_T_CONV(ecc_curve192_params_wrongGx, sizeof(ecc_curve192_params_wrongGx), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P192,
    .bytesize = 24,
};

static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_curve192_params_wrongQ[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x99, 0xde, 0xf8, 0x36, 0x14, 0x6b, 0xc9, 0xb1, 0xb4, 0xd2, 0x28, 0x31,   //q
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x99, 0xde, 0xf8, 0x36, 0x14, 0x6b, 0xc9, 0xb1, 0xb4, 0xd2, 0x28, 0x31,     //n
    0x18, 0x8d, 0xa8, 0x0e, 0xb0, 0x30, 0x90, 0xf6, 0x7c, 0xbf, 0x20, 0xeb, 0x43, 0xa1, 0x88, 0x00, 0xf4, 0xff, 0x0a, 0xfd, 0x82, 0xff, 0x10, 0x12,      //gx
    0x07, 0x19, 0x2b, 0x95, 0xff, 0xc8, 0xda, 0x78, 0x63, 0x10, 0x11, 0xed, 0x6b, 0x24, 0xcd, 0xd5, 0x73, 0xf9, 0x77, 0xa1, 0x1e, 0x79, 0x48, 0x11,     //gy
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc,    //a
...
const sx_ecc_curve_t sx_ecc_curve_curve192_wrongQ = {
    .params  = BLOCK_T_CONV(ecc_curve192_params_wrongQ, sizeof(ecc_curve192_params_wrongQ), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME) | BA414EP_SELCUR_ACCEL_P192,
    .bytesize = 24,
};

//IP owner's pattern begin
static const uint8_t __attribute__((aligned(CACHE_LINE))) ecc_p256_params_iptest[] = {
...
const sx_ecc_curve_t sx_ecc_curve_p256_iptest = {
    .params  = BLOCK_T_CONV(ecc_p256_params_iptest, sizeof(ecc_p256_params_iptest), EXT_MEM),
    .pk_flags = BA414EP_CMD_OPFLD(BA414EP_OPFLD_PRIME),
    .bytesize = 32,
};
...
static const ec_list_element curve_list[] = {
    ...
    {
        NID_X9_62_prime_field, &sx_ecc_sm2_curve_p256_rev,
...
const void * get_curve_value_by_nid(int nid)
{
    ...
    const void* ecc_curve_temp = NULL;
    size_t i;
    ...
    for (i = 0; i < curve_list_length; i++) {
        if (curve_list[i].nid == nid) {
            ecc_curve_temp = curve_list[i].data;
            break;
        }
    }

    return ecc_curve_temp;
}