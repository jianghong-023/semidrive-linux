...
#define SEC_AP2_MEMBASE 0x38D00000
#define SEC_AP2_MEMSIZE 0x100000
#define SAF_AP2_MEMBASE 0x38E00000
#define SAF_AP2_MEMSIZE 0x1000000
#define SAF_MEMBASE 0x39E00000
#define SAF_MEMSIZE 0x2000000
#define AP2_ATF_MEMBASE 0x4BE00000
#define AP2_ATF_MEMSIZE 0x200000
#define AP2_REE_MEMBASE 0x4C000000
#define AP2_REE_MEMSIZE 0x34000000
#define AP2_PRELOADER_MEMBASE 0x4E000000
#define AP2_PRELOADER_MEMSIZE 0x400000
#define AP2_BOOTLOADER_MEMBASE 0x50400000
#define AP2_BOOTLOADER_MEMSIZE 0x800000
#define AP2_KERNEL_MEMBASE 0x4C280000
#define AP2_KERNEL_MEMSIZE 0x33E00000
#define AP2_BOARD_RAMDISK_MEMBASE 0x54000000
