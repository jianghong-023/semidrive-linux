...
const dcf_configs_t dcf_configs_list = {
	...
	.dcf_config[0].paddr = 0x32900000,
	.dcf_config[0].size = 0x80000,
	.dcf_config[0].mid_src = 0,
	.dcf_config[0].mid_dst = 1,
	.dcf_config[0].mid_master = 1,
	.dcf_config[0].channel = 0,
	.dcf_config[1].res_id = RES_DDR_DDR_MEM_SAF_SDPE,
	.dcf_config[1].paddr = 0x32980000,
	.dcf_config[1].size = 0x80000,
	.dcf_config[1].mid_src = 0,
	.dcf_config[1].mid_dst = 2,
	.dcf_config[1].mid_master = 2,
	.dcf_config[1].channel = 1,
	.dcf_config[2].res_id = RES_DDR_DDR_MEM_SAF_AP2,
	.dcf_config[2].paddr = 0x32A00000,
	.dcf_config[2].size = 0x80000,
	.dcf_config[2].mid_src = 0,
	.dcf_config[2].mid_dst = 4,
	.dcf_config[2].mid_master = 4,
	.dcf_config[2].channel = 2,
	.dcf_config[3].res_id = RES_DDR_DDR_MEM_SDPE_AP2,
	.dcf_config[3].paddr = 0x32A80000,
	.dcf_config[3].size = 0x80000,
	.dcf_config[3].mid_src = 2,
	.dcf_config[3].mid_dst = 4,
	.dcf_config[3].mid_master = 4,
	.dcf_config[3].channel = 3,
	.dcf_config[4].res_id = RES_DDR_DDR_MEM_SEC_AP2,
	.dcf_config[4].paddr = 0x32B00000,
	.dcf_config[4].size = 0x100000,
	.dcf_config[4].mid_src = 1,
	.dcf_config[4].mid_dst = 4,
	.dcf_config[4].mid_master = 4,
	.dcf_config[4].channel = 4,
	.dcf_config[5].res_id = RES_DDR_DDR_MEM_SEC_SDPE,
	.dcf_config[5].paddr = 0x32C00000,
	.dcf_config[5].size = 0x200000,
	.dcf_config[5].mid_src = 1,
	.dcf_config[5].mid_dst = 2,
	.dcf_config[5].mid_master = 2,
