...
#define SAF_AP2_MEMBASE 0x32B00000
#define SAF_AP2_MEMSIZE 0x80000
#define SDPE_AP2_MEMBASE 0x32B80000
#define SDPE_AP2_MEMSIZE 0x80000
#define SEC_AP2_MEMBASE 0x32C00000
#define SEC_AP2_MEMSIZE 0x200000
#define SEC_SDPE_MEMBASE 0x32E00000
#define SEC_SDPE_MEMSIZE 0x200000
#define AP2_ATF_MEMBASE 0x43000000
#define AP2_ATF_MEMSIZE 0x200000
#define AP2_REE_MEMBASE 0x43200000
#define AP2_REE_MEMSIZE 0x3CE00000
#define AP2_PRELOADER_MEMBASE 0x45200000
#define AP2_PRELOADER_MEMSIZE 0x400000
#define AP2_BOOTLOADER_MEMBASE 0x47600000
#define AP2_BOOTLOADER_MEMSIZE 0x800000
#define AP2_KERNEL_MEMBASE 0x43480000
#define AP2_KERNEL_MEMSIZE 0x3CC00000
#define AP2_BOARD_RAMDISK_MEMBASE 0x4B200000
