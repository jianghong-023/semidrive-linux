...
#define RPMSG0_MEM_HEAD_BASE	RPMSG_MEM_CONV(SAF_CLU_MEMBASE)
...
#define RPMSG1_MEM_HEAD_BASE	RPMSG_MEM_CONV(SEC_CLU_MEMBASE)
...
#define RPMSG3_MEM_HEAD_BASE	ECO_CLU_MEMBASE
